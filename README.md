...
Адаптивним веб-дизайном називать дизайн, що забезпечує оптимальне відображення та взаємодію сайту з користувачем, тобто візуальний вигляд сайту на різних присторах.  
### Я вивчила ось такі команди:
```
